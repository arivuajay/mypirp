            ...
            <section class="content">
                <div class="row">
                    ...
                    $form = $this->beginWidget('CActiveForm', array(
                        ...
                        'method' => 'get',
                        'action' => array('/webpanel/instructors/exceldownload/'),
            ...
            <section class="content">
                <div class="row">
                    ...
                    $form = $this->beginWidget('CActiveForm', array(
                        ...
                        'method' => 'get',
                        'action' => array('/webpanel/instructors/index/'),
                        'htmlOptions' => array('role' => 'form')
                    ));
                    ?>
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo $form->dropDownList($model, 'Affiliate', $affiliates, array('class' => 'form-control')); ?>           
                        </div>
                    </div> 

                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <?php echo $form->labelEx($model, 'Instructor', array('class' => ' control-label')); ?>
                            <?php echo $form->dropDownList($model, 'Instructor', $instructors, array('class' => 'form-control')); ?>    
                        </div>
                    </div> 
