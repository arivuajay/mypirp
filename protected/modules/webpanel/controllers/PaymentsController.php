...
//                $querydel	 = "Delete from dmv_payment where class_id='$class_id'";			
//                $querydel2	= "Delete from dmv_print_certificate where class_id='$class_id'";		
//                $querydel3	= "Delete from dmv_students  where clas_id='$class_id'";			
//                $querydel1	= "Delete from dmv_classes  where clas_id='$class_id'";
