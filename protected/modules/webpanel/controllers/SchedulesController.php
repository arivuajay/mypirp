...
class SchedulesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['DmvClasses']))
		{
			...
			if($model->save()){
                                Yii::app()->user->setFlash('success', 'DmvClasses Created Successfully!!!');
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['DmvClasses']))
		{
			$model->attributes=$_POST['DmvClasses'];
			if($model->save()){
                                Yii::app()->user->setFlash('success', 'DmvClasses Updated Successfully!!!');
                                $this->redirect(array('index'));
                        }
		}
	...
	public function actionDelete($id)
	{
		...
		if(!isset($_GET['ajax'])){
                    Yii::app()->user->setFlash('success', 'DmvClasses Deleted Successfully!!!');
