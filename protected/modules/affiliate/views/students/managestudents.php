...
<div class="col-lg-12 col-md-12">
    <div class="row">
        <?php echo CHtml::link('<i class="fa fa-plus"></i>&nbsp;&nbsp;Add Student', array('/affiliate/students/create'), array('class' => 'btn btn-success pull-right')); ?>
    </div>
</div>
        ...
        <div class="row">
            ...
            $gridColumns = array(
                ...
                array(
                    ...
                    'filter' => false,
                    'value' => function($data) {
                        echo ($data->studentsCount > 0) ? "<a href='" . Yii::app()->createAbsoluteUrl("/affiliate/students/viewstudents/cid/" . $data->clas_id) . "'>View/Edit students</a>" : "There are no records in this class";
                    }
                ),
            );
