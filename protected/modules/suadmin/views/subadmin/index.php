...
$this->title = 'Sub Admin Management';
    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <div class="nav navbar-right">
                <?php echo CHtml::link('<i class="fa fa-plus"></i>&nbsp;&nbsp;Create Subadmin', array('/suadmin/subadmin/create'), array('class' => 'btn btn-success btn-sm pull-right')); ?>                  
            </div>
