...
/**
 * This is the model class for table "dmv_sresources".
 *
 * The followings are the available columns in table 'dmv_sresources':
 ...
 */
class DmvSresources extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
                        'Childs' => array(self::HAS_MANY, 'DmvSresources', 'parent_id'),
		);
	}
	 ...
	 * @return DmvSresources the static model class
	 */
